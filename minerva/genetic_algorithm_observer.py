...
from configuration_backtest import STRATEGIES_FOLDER, experiment_number
from oracle import store_perfomances
...
while True:
    monitor_performances(filepath='minerva/runs/experiment_210/generation_0')
