#!/usr/bin/env python3
from configurations import DATASTREAMER_URL, ORACLE_URL, TOPICS_DATASTRAMER, TOPICS_ORACLE
from configurations import N_TICKS_VIZUALIZER,  MARKET, REQUEST_TIME_INTERVAL, TRADING_OPERATION
import zmq
import json
